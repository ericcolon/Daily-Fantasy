#' Looping function for the swish batter ratings
#'
#' @param swishModel 
#' @param labsModel 
#'
#' @return a set of projections
#' @export
#'
#' @examples swisherlyLabModelLoop(swishModel = sModel, labsModel = lModel)
swisherlyLabModelLoop<-function(swishModel=sModel,labsModel=lModel){
